...
<div class="max-w-2xl mx-auto">
    <div class="mb-6 flex items-center">
        ...
        <h3 class="text-lg font-semibold text-slate-700">Form Lab Baru</h3>
    </div>
        ...
        <form action="{{ route('labs.store') }}" method="POST">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="nama" id="nama" value="{{ old('nama') }}" class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-100 focus:border-blue-400 outline-none transition-all placeholder:text-slate-400" placeholder="Contoh: Lab Komputer 1, Lab RPL" required>
                ...
                <div class="pt-4 border-t border-slate-100 flex justify-end space-x-3">
                    ...
                    <button type="submit" class="px-6 py-2.5 bg-blue-600 text-white text-sm font-semibold rounded-xl hover:bg-blue-700 shadow-lg shadow-blue-200 transition-all">Simpan Lab</button>
                </div>
            </div>
        </form>
    </div>
